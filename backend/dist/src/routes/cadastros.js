...
import { createEmpresaController, createProdutoController, createServicoController, createUsuarioController, deleteEmpresaController, deleteProdutoController, deleteServicoController, deactivateUsuarioController, activateUsuarioController, getEmpresaController, getProdutoController, getServicoController, getUsuarioController, listEmpresasController, listProdutosController, listServicosController, listUsuariosController, updateEmpresaController, updateProdutoController, updateServicoController, updateUsuarioController, } from "../controllers/cadastros.controller.js";
export async function cadastrosRoutes(app) {
    const adminOnly = [authenticate, authorize(["ADMIN"])];
    const contributor = [authenticate, authorize(["ADMIN", "OPERADOR"])];
