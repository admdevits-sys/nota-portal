 ...
 */
async function validateNFeAtADN(chaveAcesso, nota) {
    const erros = [];
 ...
 */
async function validateNfseAtNacional(chaveAcesso, nota) {
    const erros = [];
 ...
 */
export async function validateXmlByChaveService(input) {
 ...
 */
export async function getValidationHistory(usuarioId, page = 1, limit = 20) {
